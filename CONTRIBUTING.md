...
## Automatic fixes (postinstall)

After `pnpm install`, the `postinstall` script (`scripts/fix-foliate.mjs`) automatically applies two patches to the foliate-js submodule:
